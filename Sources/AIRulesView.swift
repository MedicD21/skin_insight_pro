                        ...
                        VStack(alignment: .leading, spacing: 16) {
                                ...
                                TextEditor(text: $condition)
                                    ...
                                    .overlay(
                                        RoundedRectangle(cornerRadius: theme.radiusMedium)
                                            .stroke(focusedField == .condition ? theme.accent : theme.border, lineWidth: focusedField == .condition ? 2 : 1)
                                    )
                            ...
                            VStack(alignment: .leading, spacing: 8) {
                                ...
                                TextEditor(text: $action)
                                    ...
                                    .overlay(
                                        RoundedRectangle(cornerRadius: theme.radiusMedium)
                                            .stroke(focusedField == .action ? theme.accent : theme.border, lineWidth: focusedField == .action ? 2 : 1)
                                    )
